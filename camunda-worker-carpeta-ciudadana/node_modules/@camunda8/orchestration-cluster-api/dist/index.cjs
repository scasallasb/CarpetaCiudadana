...
var zMessageSubscriptionResult = import_zod.z.object({
  ...
  correlationKey: import_zod.z.optional(zMessageCorrelationKey),
  tenantId: import_zod.z.optional(zTenantId)
});
...
var zProblemDetail = import_zod.z.object({
  ...
  instance: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zMessageCorrelationResult = import_zod.z.object({
  tenantId: import_zod.z.optional(zTenantId),
  messageKey: import_zod.z.optional(zMessageCorrelationKey),
  processInstanceKey: import_zod.z.optional(zProcessInstanceKey)
}).register(import_zod.z.globalRegistry, {
